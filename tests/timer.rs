...
mod tests {
    ...
    fn test_start_and_wait(state: &mut super::State) {
        state.pit.ch0.start(fugit::MicrosDurationU32::millis(1));
    ...
    fn test_wait_would_block(state: &mut super::State) {
        state.pit.ch0.start(fugit::MicrosDurationU32::secs(1));
    ...
    fn test_channels_independent(state: &mut super::State) {
        state.pit.ch0.start(fugit::MicrosDurationU32::millis(10));
        state.pit.ch1.start(fugit::MicrosDurationU32::millis(50));
